...
[Route-Progress-Dienst](https://github.com/madebylk/route-progress). Sie erstellt
...
`ROUTE_PROGRESS_HA_TOKEN` konfigurierte Bearer-Token und ein
...
[`madebylk/route-progress`](https://github.com/madebylk/route-progress).
